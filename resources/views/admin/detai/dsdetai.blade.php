...
<div id="content-wrapper">
	<div class="container-fluid" ng-controller="DeTaiController">
		<div class="card mb-3">
			<div class="card-header">
				<h5 class="fas fa-table" style="display: inline-block;"> Danh sách đề tài ngành </h5>
...
@section('custom-js')
<script src="{{asset('app/DeTaiController.js')}}"></script>
@endsection